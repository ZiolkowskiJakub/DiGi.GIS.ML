...
namespace OrtoBuildingDetectionModelConsoleApp
{
    public partial class OrtoBuildingDetectionModel
    {
        ...
        /// is then saved to the location specified by <paramref name="folderPath" />.
        ///
        ...
        /// <param name="folderPath">The path to the folder where the regression chart HTML file will be saved.</param>
        public static void PlotRSquaredValues(IDataView trainData, ITransformer model, string labelColumnName, string folderPath)
        {
            ...
            var xAxis = LinearAxis.init<float, float, string, string, string, string, string, string>(
                    Title: Title.init("True Values"),
                    ZeroLineColor: Color.fromString("#ffff"),
                    GridColor: Color.fromString("#ffff"),
                    ZeroLineWidth: 2);
            var yAxis = LinearAxis.init<float, float, string, string, string, string, string, string>(
            ...
            var chartWithValuesAndIdealLine = Chart.Combine([trueAndPredictedValues, perfectLineGraph]);
