...
**DiGi.GIS.ML** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.GIS.ML](DiGi.GIS.ML)** (Path: `DiGi.GIS.ML\DiGi.GIS.ML`)
* **[OrtoBuildingDetectionModelConsoleApp](OrtoBuildingDetectionModelConsoleApp)** (Path: `DiGi.GIS.ML\OrtoBuildingDetectionModelConsoleApp`)
